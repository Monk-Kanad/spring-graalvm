...
* The original package name 'com.meteor.spring-graalvm' is invalid and this project uses 'com.meteor.springgraalvm' instead.
...
```
$ docker run --rm spring-graalvm:0.0.1-SNAPSHOT
```
